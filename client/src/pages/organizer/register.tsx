                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input 
                        ...
                        error={registerForm.formState.errors.companyRegistrationNumber?.message}
                      />
                    ...
                    <div className="space-y-2">
                      ...
                      <Input 
                        ...
                        error={registerForm.formState.errors.agencyLicense?.message}
                      />
                    ...
                    <div className="space-y-2 sm:col-span-2">
                      ...
                      <Input 
                        ...
                        error={registerForm.formState.errors.companyAddress?.message}
                      />
                    ...
                    <div className="space-y-2 sm:col-span-2">
                      ...
                      <Input 
                        ...
                        error={registerForm.formState.errors.website?.message}
                      />
                    ...
                    <div className="space-y-2 sm:col-span-2">
                      ...
                      <Textarea 
                        ...
                        error={registerForm.formState.errors.description?.message}
                      />
